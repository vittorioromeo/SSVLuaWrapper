...
LinkOptions            :=  
IncludePath            :=  $(IncludeSwitch). $(IncludeSwitch)./include/ $(IncludeSwitch)../lua/include/ $(IncludeSwitch)../lua/ 
IncludePCH             := 
RcIncludePath          := 
Libs                   := $(LibrarySwitch)../lua/lua5.1.lib 
ArLibs                 :=  "../lua/lua5.1.lib" 
LibPath                := $(LibraryPathSwitch). $(LibraryPathSwitch)../lua/ 
